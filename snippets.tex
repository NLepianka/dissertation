...
\1 From \textit{The Arrangement of Bibliogrpahies}
	\2 2 distinct problems:
		\3 1. how to discover books.
		\3 2. how to best arrange them them.
...
\1 Blanck said the working list would be made available but maybe I should ask Winship sometime about whether or not the list was ever made available. 

\1 
	
\end{outline}
		
\section{19th c. American Stuff}
\begin{outline}
\1 Via, Drucker: The Rosetta stone allowed for the deciphering of Egyptian Hieroglyphs. This was done in 1799. (\textit{Alphabetic Labyrinth, 239}
	\2 \n This would explain Irwin's premise in \textit{American Hieroglyphs}
	
\section{American Bibliographies}
Charles Evans, \textit{American Bibliography}
Joseph Sabin, \textit{A Dictionary of Books Relating to America, from its Discovery to the Present Time. }
Merle Johnson, \textit{American First Editions}
Jacob Blanck, \textit{Bibliography of American Literature}
Lyle H. Wright, \textit{American Fiction}

Roger P. Bristol, \textit{Supplement to Charles Evans' American Bibliography}
Winship and Eppard, \textit{Epitome of American Literature}
